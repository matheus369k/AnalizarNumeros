...
![analise-number-preview](public/analise-number-preview.png)
...
<img
    width="100%"
    style="outline: none; border: 1px solid black; border-radius: 10px"
    src="public/analize-number-preview.gif"
    alt="preview da pagina analize number"
/>
